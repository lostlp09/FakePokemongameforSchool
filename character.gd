...
var basti: character = character.new(100, "fire", 5, "fire", 5, "fire", 5, "neutral", "basti", preload("res://fly.tres"))
var Monkey: character = character.new(100, "water", 30, "water", 20, "neutral", 10, "neutral", "blob", preload("res://blob.tres"))
var Giraffe: character = character.new(150, "plant", 20, "plant", 0, "plant", 30, "plant", "Giraffe", preload("res://blob.tres"))
var Sporal: character = character.new(500, "ice", 0, "water", 0, "wind", 20, "ice", "sporal",preload("res://sporal.tres"))
